...
from .utils.V2.check_for_characters import check_characters
from .utils.V2.tts_engine_V2 import generate_text
from .utils.V2.progress_tracker import ProgressTracker
...
class EbookToAudio:
    ...
    def auto_generate(self, input_text, filename="Untitled", task_id="default"):
        # Если нам передали путь строкой — читаем файл
